...
class SpikingVisNet:
    ...
    def __init__(self):
        ...
        self.network = Network(self.L0, self.L1, self.L1_exc, self.L2, self.L2_exc, self.L3, self.L3_exc, self.L4, self.L4_exc, self.L1_inh, self.L2_inh, self.L3_inh, self.L4_inh, 
    ...
    def _build_layers(self):
        ...
        tau_e = 50*ms           # Excitatory synaptic time constant
        tau_i = 50*ms          # Inhibitory synaptic time constant
        tau_r = 5*ms           # Refractory period
        V_th = -10*mV          # Firing threshold
        V_r = E_l              # Reset potential
        
        # synapse parameters
        w = 0.01*nS          # Excitatory synaptic conductance
        ...
        self.L1.g_e = 'rand()*w' # random initial excitatory conductances
        self.L1.g_i = 'rand()*w' # random initial inhibitory conductances
        ...
        self.L2.g_e = 'rand()*w' # random initial excitatory conductances
        self.L2.g_i = 'rand()*w' # random initial inhibitory conductances
        ...
        self.L3.g_e = 'rand()*w' # random initial excitatory conductances
        self.L3.g_i = 'rand()*w' # random initial inhibitory conductances
        ...
        self.L4.g_e = 'rand()*w' # random initial excitatory conductances
        self.L4.g_i = 'rand()*w' # random initial inhibitory conductances
    ...
    def _image_to_spikes(self, image, filters):
        ...
        self.L0.rate = flattened_filtered_image * 100/2550 * Hz # set firing rates of L0 Poisson neurons equal to outputs of Gabor filters - multiply by a coefficient (10e-8) to get biologically realistic values
