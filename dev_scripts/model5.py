...
class SpikingVisNet:
    ...
    def _build_layers(self):
        ...
        poisson_neuron_spacing = 50*umetre  # spacing between neurons
        ...
        g_l = 50*nS            # leak conductance
        E_e = 10*mV            # excitatory synaptic reversal potential
        E_i = -80*mV           # inhibitory synaptic reversal potential
        C_m = 2*nF             # membrane capacitance
        tau_e = 4*ms          # excitatory synaptic time constant
        tau_i = 4*ms          # inhibitory synaptic time constant
        tau_r = 5*ms           # refractory period
        V_th = -10*mV          # firing threshold
        V_r = E_l              # reset potential
        
        # synapse parameters
        cond = 3*nS          # for setting of initial synaptic conductance
        ...
        LIF_neurons='''
        dv/dt  = (g_e+g_i-(v-El))/taum   : volt (unless refractory) # membrane potential (LIF equation)               
    ...
    def _connect_layers(self):
        ...
        tau_w = 150*ms  # time constant for ODE describing synaptic weight
        lamda = 20      # scaling factor for increase in synaptic conductance upon spike
        alpha_C = 0.5   # synaptic glutamate concentration scaling constant
        alpha_D = 0.5   # proportion of unblocked NMDA receptors scaling constant
        gmax = 20*nS    # max synaptic conductance
        ...
        # synapse equations
        STDP_synapse_eqs = '''
        dw/dt = rho*(((1*siemens-w)*C_pre-w*D_post)/tau_w) : siemens # synaptic weight (STDP function - see variables A and B below)
        '''
        ...
        self.Syn_L0_L1_exc = Synapses(self.L0, self.L1_exc, model=STDP_synapse_eqs, on_pre=on_pre_exc, on_post=STDP_on_post_exc, method='euler') # create synapses with STDP learning rule
        ...
        self.Syn_L1_exc_L2_exc = Synapses(self.L1_exc, self.L2_exc, model=STDP_synapse_eqs, on_pre=on_pre_exc, on_post=STDP_on_post_exc, method='euler')            
        ...
        self.Syn_L2_exc_L3_exc = Synapses(self.L2_exc, self.L3_exc, model=STDP_synapse_eqs, on_pre=on_pre_exc, on_post=STDP_on_post_exc, method='euler')             
        ...
        self.Syn_L3_exc_L4_exc = Synapses(self.L3_exc, self.L4_exc, model=STDP_synapse_eqs, on_pre=on_pre_exc, on_post=STDP_on_post_exc, method='euler')              
        ...
        self.Syn_L1_exc_L1_inh = Synapses(self.L1_exc, self.L1_inh, model=non_STDP_synapse_eqs, on_post=non_STDP_on_post_exc, method='euler')
        ...
        self.Syn_L1_inh_L1_exc = Synapses(self.L1_inh, self.L1_exc, model=non_STDP_synapse_eqs, on_post=on_post_inh, method='euler')
        ...
        self.Syn_L2_exc_L2_inh = Synapses(self.L2_exc, self.L2_inh, model=non_STDP_synapse_eqs, on_post=non_STDP_on_post_exc, method='euler')
        ...
        self.Syn_L2_inh_L2_exc = Synapses(self.L2_inh, self.L2_exc, model=non_STDP_synapse_eqs, on_post=on_post_inh, method='euler')
        ...
        self.Syn_L3_exc_L3_inh = Synapses(self.L3_exc, self.L3_inh, model=non_STDP_synapse_eqs, on_post=non_STDP_on_post_exc, method='euler')
        ...
        self.Syn_L3_inh_L3_exc = Synapses(self.L3_inh, self.L3_exc, model=non_STDP_synapse_eqs, on_post=on_post_inh, method='euler')
        ...
        self.Syn_L4_exc_L4_inh = Synapses(self.L4_exc, self.L4_inh, model=non_STDP_synapse_eqs, on_post=non_STDP_on_post_exc, method='euler')
        ...
        self.Syn_L4_inh_L4_exc = Synapses(self.L4_inh, self.L4_exc, model=non_STDP_synapse_eqs, on_post=on_post_inh, method='euler')
        ...
        self.Syn_L4_exc_L3_exc = Synapses(self.L4_exc, self.L3_exc, model=non_STDP_synapse_eqs, on_post=non_STDP_on_post_exc, method='euler')              
        ...
        self.Syn_L3_exc_L2_exc = Synapses(self.L3_exc, self.L2_exc, model=non_STDP_synapse_eqs, on_post=non_STDP_on_post_exc, method='euler')              
        ...
        self.Syn_L2_exc_L1_exc = Synapses(self.L2_exc, self.L1_exc, model=non_STDP_synapse_eqs, on_post=non_STDP_on_post_exc, method='euler')              
